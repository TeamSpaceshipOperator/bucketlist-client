...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signIn(data).then(ui.signInSuccess).then(onGetAllRestaurants).catch(ui.signInError);
};
...
var onCreateRestaurant = function onCreateRestaurant(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.createRestaurant(data).then(ui.createRestaurantSuccess).catch(ui.createRestaurantFailure);
};

var onGetAllRestaurants = function onGetAllRestaurants() {
  // event.preventDefault()
  authApi.getRestaurants().then(ui.getRestaurantsSuccess).catch(ui.getRestaurantsFailure);
};

var onGetMyRestaurants = function onGetMyRestaurants(event) {
  event.preventDefault();
  authApi.getRestaurants().then(ui.getRestaurantsSuccess).catch(ui.getRestaurantsFailure);
};

var onDestroyRestaurant = function onDestroyRestaurant(event) {
  event.preventDefault();
  var data = $(this).data('id');
  authApi.destroyRestaurant(data).then(ui.destroyRestaurantSuccess).then(onGetAllRestaurants).catch(ui.destroyRestaurantFailure);
};
...
var onUpdateRestaurant = function onUpdateRestaurant(event) {
  ...
  var data = getFormFields(event.target);
  var id = $(this).data('id');
  authApi.updateRestaurant(data, id).then(ui.updateRestaurantSuccess).then(onGetAllRestaurants).catch(ui.updateRestaurantFail);
};

var onViewRestaurant = function onViewRestaurant(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.getRestaurant(data).then(ui.viewRestaurantSuccess).catch(ui.viewRestaurantFailure);
};

var onSearchRestaurant = function onSearchRestaurant(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.searchRestaurant(data).then(ui.searchSuccess).catch(ui.searchFail);
};
...
module.exports = {
  ...
  onGetAllRestaurants: onGetAllRestaurants,
  onDestroyRestaurant: onDestroyRestaurant,
  onUpdateRestaurant: onUpdateRestaurant,
  onViewRestaurant: onViewRestaurant,
  onSearchRestaurant: onSearchRestaurant,
  showUpdateForm: showUpdateForm,
  onGetMyRestaurants: onGetMyRestaurants
  // onAddRestaurant
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var searchRestaurant = function searchRestaurant(data) {
  return $.ajax({
    method: 'GET',
...
var getRestaurant = function getRestaurant(data) {
  return $.ajax({
    method: 'GET',
...
var destroyRestaurant = function destroyRestaurant(data) {
  return $.ajax({
    method: 'DELETE',
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://young-mountain-70476.herokuapp.com',
...
var store = __webpack_require__(3);
var showRestaurantList = __webpack_require__(13);
var showSearchList = __webpack_require__(30);
...
var createRestaurantSuccess = function createRestaurantSuccess(Response) {
  $('#add-success').modal();
};

var createRestaurantFailure = function createRestaurantFailure(response) {
  console.error(response);
  $('.createRestaurantFeedback').html('Please fill both fields.');
};

var getRestaurantsSuccess = function getRestaurantsSuccess(getRestaurantsResponse) {
  var showRestaurantsHtml = showRestaurantList({ restaurants: getRestaurantsResponse.restaurants });
  $('.content').html(showRestaurantsHtml);
};

var destroyRestaurantSuccess = function destroyRestaurantSuccess(response) {};

var updateRestaurantSuccess = function updateRestaurantSuccess(updateRestaurantResponse) {};

var updateRestaurantFail = function updateRestaurantFail(error) {
  console.error(error);
};

var viewRestaurantSuccess = function viewRestaurantSuccess(viewRestaurantResponse) {
  $('.view_row').html(viewRestaurantResponse.restaurant.name);
};

var searchSuccess = function searchSuccess(searchResponse) {
  var showSearchHtml = void 0;
...
var searchFail = function searchFail(searchFailResponse) {};

var viewRestaurantFailure = function viewRestaurantFailure(error) {
  console.error(error);
};
...
module.exports = {
  ...
  destroyRestaurantSuccess: destroyRestaurantSuccess,
  // deleteRestaurantFailure,
  updateRestaurantSuccess: updateRestaurantSuccess,
  updateRestaurantFail: updateRestaurantFail,
  viewRestaurantSuccess: viewRestaurantSuccess,
  viewRestaurantFailure: viewRestaurantFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <div class=\"display col-sm-12\" data-id=\""
    ...
    + "</p>\n     </div>\n   </div>\n   <hr>\n   <form class=\"add-note-form\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n\n       <p class=\"handlebars-display\"><span class=\"glyphicon glyphicon-pencil\"></span>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "</p>\n       <input class=\"handlebars-form-hider handlebars-form-hider-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"restaurant[notes]\" type=\"text\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "\">\n     <button class=\"handlebars-update-button handlebars-display handlebars-display-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Add Note</button>\n     <button class=\"handlebars-submit-button handlebars-form-hider handlebars-form-hider-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Submit Note</button>\n   </div>\n </form>\n\n\n\n   </div>\n</div>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <div class=\"display col-sm-12\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n   <div class=\"row\">\n     <div class=\"col-sm-11 top-spacer\"></div>\n     <div class=\"col align-self-end\"><a href=\"#\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\"></a></div>\n     <div class=\"col-sm-10 offset-sm-1 search-img\">\n       <img src="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.image_url : stack1), depth0))
    + " height=\"174\" width=\"261\">\n     </div>\n   </div>\n   <div class=\"row\">\n     <div class=\"col-sm-1\"></div>\n   <div class=\"col-sm-11\">\n     <p class=\"handlebars-display\"><span class=\"glyphicon glyphicon-cutlery\"></span>  "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</p>\n     <input class=\"handlebars-form-hider\" name=\"restaurant[name]\" type=\"text\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n   </div>\n </div>\n   <hr>\n   <div class=\"row\">\n     <div class=\"col-sm-1\"></div>\n   <div class=\"col-sm-11\">\n     <p class=\"handlebars-display\"><span class=\"glyphicon glyphicon-map-marker\"></span>  "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.location : stack1)) != null ? stack1.address1 : stack1), depth0))
    + " <br> "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.location : stack1)) != null ? stack1.city : stack1), depth0))
    + ", "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.location : stack1)) != null ? stack1.zip_code : stack1), depth0))
    + "</p>\n     <input class=\"handlebars-form-hider\" name=\"restaurant[location]\" type=\"text\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
    + "\">\n   </div>\n   <form class=\"handlebars-add-form\">\n     <input type=\"hidden\" name=\"restaurant[name]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n     <input type=\"hidden\" name=\"restaurant[location]\" value=\""
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.location : stack1)) != null ? stack1.address1 : stack1), depth0))
    + ", "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.location : stack1)) != null ? stack1.city : stack1), depth0))
    + ", "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.location : stack1)) != null ? stack1.zip_code : stack1), depth0))
    + "\">\n     <input type=\"hidden\" name=\"restaurant[imgUrl]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.image_url : stack1), depth0))
    + "\">\n   <button type=\"submit\" class=\"handlebars-form-submit\">Add to list</button>\n </form>\n   <button class=\"handlebars-submit-button handlebars-form-hider\" type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
